...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // Use shared API helper; proxy rewrites /api -> /api/v1
      ...
      if (data.success) {
        ...
        // ✅ Redirect based on role (student or coach only)
        if (data.user.role === "student") {
          navigate("/student/home");
        } else if (data.user.role === "coach") {
          navigate("/coach/home");
        } else if (data.user.role === "admin") {
          // Admin should use /admin-login page, but if they come here, redirect them
          alert("Please use the Admin Portal login page.");
